...
function exportToExcel($data) {
    ...
    header("Content-Disposition: attachment; filename=Scheduled Sessions.xls");
...
function exportToPDF($data) {
    ...
    $pdf = new TCPDF();
    $pdf->AddPage();
    $html = '<h2>Scheduled Sessions</h2><table border="1"><tr>';
    ...
    $pdf->Output('Scheduled Sessions.pdf', 'D');
    exit();
}

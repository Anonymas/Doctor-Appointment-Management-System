...
<head>
    ...
    <style>
        ...
        .header-container .date-container p {
            margin: 0;
            font-size: 20px;
            color: #000;
        }
        .header-container .date-container .heading-sub12 {
            font-size: 20px;
        }
    </style>
</head>
...
<section class="home">
    ...
    <section class="hero-section">
        <div class="content">
            ...
            <p>
                Keep Yourself & Your Family Safe. Access Healthcare Services Anytime from Anywhere with Prime Care!<br>
                Don't Worry. Find Your Doctor Online And Book As You Wish With Prime Care.
            </p>

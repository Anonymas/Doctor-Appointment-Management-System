...
<body>
    ...
    // Checks if the form has been submitted
        ...
        if ($password == $cpassword) {
            ...
            if ($result->num_rows == 1) {
                ...
                // Inserts the new patient's details into the "patients" table
                $sql1 = "insert into patient(pemail,pname,ppassword,paddress,pidnumber,pdob,ptel) values('$email','$name','$password','$address','$idnumber','$dob','$tele');";
    ...
    // Redirects to the patient page with an action and error code in the query string
